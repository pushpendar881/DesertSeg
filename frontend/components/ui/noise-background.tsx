...
export const NoiseBackground = ({
  ...
  containerClassName,
  gradientColors = [
    "hsl(186, 68%, 72%)", // primary - teal
    "hsl(148, 64%, 73%)", // mint-green
    "hsl(216, 73%, 53%)", // royal-blue
  ],
  noiseIntensity = 0.15,
  speed = 0.08,
  backdropBlur = false,
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "group relative rounded-lg bg-card",
        "border border-border/50",
        "shadow-[0px_0.5px_1px_0px_hsl(var(--border))_inset,0px_1px_0px_0px_hsl(var(--card))]",
        backdropBlur &&
    ...
    >
      ...
      {/* Top gradient strip */}
      <motion.div
        className="absolute inset-x-0 top-0 h-1 rounded-t-lg opacity-70 blur-sm"
        style={{
